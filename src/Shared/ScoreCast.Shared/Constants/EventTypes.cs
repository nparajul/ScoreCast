...
{
    public const string Goal = nameof(Goal);
    public const string PenaltyGoal = nameof(PenaltyGoal);
    public const string OwnGoal = nameof(OwnGoal);
    ...
    public const string SubOut = nameof(SubOut);
}
